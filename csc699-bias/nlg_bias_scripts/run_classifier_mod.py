...
def train(args, train_dataset, model, tokenizer, labels, pad_token_label_id):
	...
	if args.max_steps > 0:
		...
		args.num_train_epochs = args.max_steps // (len(train_dataloader) // (args.gradient_accumulation_steps + 1)) + 1
	else:
	...
	if os.path.exists(args.model_name_or_path):
		...
		epochs_trained = global_step // (len(train_dataloader) // (args.gradient_accumulation_steps + 1))
		steps_trained_in_current_epoch = global_step % (len(train_dataloader) // (args.gradient_accumulation_steps + 1))
